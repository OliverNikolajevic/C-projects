...
void window(){
    ...
    gotoxy(7,2);
    SetColor(35);
    printf("\t\tStudents who studying Structured Programming (C) ");
    gotoxy(19,3);
    printf("and Object Oriented Programming (C++) ");
    gotoxy(31,4);
    printf("MAKEDONIJA - SKOPJE");
    gotoxy(25,24);
    SetColor(17);
...
void print_heading(const char st[]){
    ...
    gotoxy(45,8);printf("Student : %s",st);
...
int main(){
    ...
    SetConsoleTitle("by Oliver Nikolajevic");
    window();
    //use_pass_field();
    main_window();
    return 0;
