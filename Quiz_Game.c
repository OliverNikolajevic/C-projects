...
int main()
    ...
    printf("\n    total of 10 questions.You will be given 4 options and you have to press ");
    printf("\n    A, B ,C or D for the right option.");
...
void show_record()
	...
	printf("\n\n\t\t*************************************************************");
	printf("\n\n\t\t %s has secured the Highest Score %0.2f points",name,scr);
	printf("\n\n\t\t*************************************************************");
	fclose(f);
	getch();}
